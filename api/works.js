...
// ── Work Index thumbnail override — model shots ──────────────
// slug 기반으로 work/index.html 썸네일을 인물컷으로 고정
const THUMB_MODEL = {
  'case_mium':       'mu-m-03.png',
  'case_balanceb':   'bb-m-03.png',
  'case_urbanpure':  'up-jl-m-01.png',
};
...
function transformPage(page) {
  ...
  const thumbFile = THUMB_MODEL[slug] || richText(props["썸네일"]);
